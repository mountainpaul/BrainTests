...
// in brain_tests/test/unit/data/repositories/daily_goals_repository_test.dart.
// Do not manually edit this file.

// ignore_for_file: no_leading_underscores_for_library_prefixes
import 'dart:async' as _i5;

import 'package:brain_tests/data/datasources/database.dart' as _i3;
...
class _Fake$WordDictionaryTableTable_4 extends _i1.SmartFake
    implements _i3.$WordDictionaryTableTable {
  _Fake$WordDictionaryTableTable_4(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$UserProfileTableTable_5 extends _i1.SmartFake
    implements _i3.$UserProfileTableTable {
  _Fake$UserProfileTableTable_5(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$CambridgeAssessmentTableTable_6 extends _i1.SmartFake
    implements _i3.$CambridgeAssessmentTableTable {
  _Fake$CambridgeAssessmentTableTable_6(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$DailyGoalsTableTable_7 extends _i1.SmartFake
    implements _i3.$DailyGoalsTableTable {
  _Fake$DailyGoalsTableTable_7(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class MockAppDatabase extends _i1.Mock implements _i3.AppDatabase {
  ...
  _i3.$WordDictionaryTableTable get wordDictionaryTable => (super.noSuchMethod(
        ...
        returnValue: _Fake$WordDictionaryTableTable_4(
          this,
          Invocation.getter(#wordDictionaryTable),
        ),
  ...
  _i3.$UserProfileTableTable get userProfileTable => (super.noSuchMethod(
        ...
        returnValue: _Fake$UserProfileTableTable_5(
          this,
          Invocation.getter(#userProfileTable),
        ),
  ...
  _i3.$CambridgeAssessmentTableTable get cambridgeAssessmentTable =>
      (super.noSuchMethod(
        ...
        returnValue: _Fake$CambridgeAssessmentTableTable_6(
          this,
          Invocation.getter(#cambridgeAssessmentTable),
        ),
  ...
  _i3.$DailyGoalsTableTable get dailyGoalsTable => (super.noSuchMethod(
        ...
        returnValue: _Fake$DailyGoalsTableTable_7(
          this,
          Invocation.getter(#dailyGoalsTable),
        ),
      ) as _i3.$DailyGoalsTableTable);
  ...
  @override
  _i5.Future<_i3.DailyGoalEntry?> getDailyGoalForDate(DateTime? date) =>
      (super.noSuchMethod(
        Invocation.method(
          #getDailyGoalForDate,
          [date],
        ),
        returnValue: _i5.Future<_i3.DailyGoalEntry?>.value(),
      ) as _i5.Future<_i3.DailyGoalEntry?>);

  @override
  _i5.Future<int> insertDailyGoal(_i3.DailyGoalEntry? goal) =>
      (super.noSuchMethod(
        Invocation.method(
          #insertDailyGoal,
          [goal],
  ...
  @override
  _i5.Future<bool> updateDailyGoal(_i3.DailyGoalEntry? goal) =>
      (super.noSuchMethod(
        Invocation.method(
          #updateDailyGoal,
          [goal],
  ...
  @override
  _i5.Future<List<_i3.DailyGoalEntry>> getAllDailyGoals() =>
      (super.noSuchMethod(
        Invocation.method(
          #getAllDailyGoals,
          [],
        ...
        returnValue:
            _i5.Future<List<_i3.DailyGoalEntry>>.value(<_i3.DailyGoalEntry>[]),
      ) as _i5.Future<List<_i3.DailyGoalEntry>>);

  @override
  _i5.Future<List<_i3.DailyGoalEntry>> getDailyGoalsInRange(
    DateTime? start,
    DateTime? end,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #getDailyGoalsInRange,
          [
            start,
            end,
          ],
  ...
  @override
  _i5.Future<void> deleteDailyGoal(int? id) => (super.noSuchMethod(
        Invocation.method(
          #deleteDailyGoal,
          [id],
        ),
